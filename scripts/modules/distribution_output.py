...
from scripts.distributions import (
    ZeroInflatedPoisson,
...
from gluonts.torch.modules import lambda_layer


from scripts.modules.iqn_modules import ImplicitQuantileModule
...
class ImplicitQuantileOutput(IndependentDistributionOutput):
    ...
    def set_args_proj(cls):
        cls.quantile_arg_proj = QuantilePtArgProj(
            ...
            domain_map=lambda_layer(cls.domain_map),
        )
